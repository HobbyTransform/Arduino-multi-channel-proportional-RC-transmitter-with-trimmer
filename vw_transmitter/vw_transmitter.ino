/* N Channel Transmitter (Proportional Control With 2 Trimmer Buttons Per Channel)
 ...
 This sketch is intended as a learning tool for multi-channel RC hobbies. It is based on
 the Arduino Debounce example by David Mellis and VirtualWire by Mike McCauley. See
 VirtualWire.h for detailed API docs.
 
 NOTE: VirtualWire uses UDP-like transmission which is simple to implement but unreliable
 (some data can be lost over transmission).
 ...
 * internal LED at pin 13 flashes to indicate sending message
